...
function classify(label: string): Tone | null {
  ...
  if (/\bNOT EXPOSED PUBLICLY\b/.test(label)) return "neutral"
  ...
  if (/\b(PARKED|ARCHIVED|NOT_STARTED|NOT STARTED|DISABLED|FUTURE|TBD|STATIC SNAPSHOT|TARGET ONLY|DOCUMENTED|BOUNDARY|SCOPED|BOUNDED|STATIC|MAP \/ NOT LIVE)\b/.test(label)) return "neutral"
