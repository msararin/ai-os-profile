  ...
  return (
    <PageLayout>
      <main>
        ...
        <section className="border-y border-border bg-[#1F3A60] py-12 text-white" aria-labelledby="status-heading"><div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8"><h2 id="status-heading" className="text-2xl font-semibold">Current Architecture Status</h2><div className="mt-6 grid gap-3 font-mono text-sm"><code>CANONICAL_BOUNDED_DURABLE_CHECKPOINT_IMPLEMENTED</code><code>MECHANICAL_CHECKPOINT_STRESS_CRITERIA_PASSED</code><code>HUMAN_OPERATIONAL_VALUE_UNRESOLVED</code><code>LANGGRAPH_PARKED</code></div><p className="mt-6 max-w-3xl text-sm leading-6 text-blue-100">Optimize-Worker has a canonical bounded recovery capability. Its mechanical behavior survived the tested interruptions. The evidence does not yet justify a human-value claim, a production-reliability claim or a framework migration.</p></div></section>
