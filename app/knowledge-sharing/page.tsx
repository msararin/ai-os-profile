...
const linkedInPosts = [
  {
    ...
    title: "Embedded post",
    date: "Jun 21, 2026",
    headline: "AI Governance Can Fail Even When Every Checklist Passes",
    summary:
      "A public reflection on how AI governance can fail when it optimizes for checkable artifacts instead of expected user-visible behavior, and how expected-behavior QA can reduce repeated human validation.",
    category: "Knowledge Sharing",
    topic: "AI Governance Failure / Expected-Behavior QA",
    status: "Published on LinkedIn",
    caveat:
      "This is a public reflection and lesson learned, not a claim of automated release governance or production-readiness certification.",
  },
  {
          ...
          {linkedInPosts.map((post) => (
            <article key={post.urn} className="border rounded-lg p-4 bg-card">
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                >
                  {post.headline ? "View LinkedIn post" : "Open on LinkedIn"}
                </a>
              </div>
