...
check "Lyn Robert(GPT) gate"               "Lyn / Robert(GPT)"                                                      "app/org-roles/page.tsx"
check "Robert(GPT) Hermes peers"           "peers via KB"                                                      "app/org-roles/page.tsx"
check "Shared truth"                  "Robert(GPT) KB + Git"                                                   "app/org-roles/page.tsx"
...
check "Glossary row 1"       "Robert(GPT) KB + Git"                                                            "app/architecture/page.tsx"
...
check "Field Evidence"       "Robert(GPT) KB decision logs, cockpit governance v0.3 + R1"                      "app/lean-value-tree/page.tsx"
...
check "P2 simplified body"    "Robert(GPT) KB and Git are the only places truth lives"                         "app/principles/page.tsx"
...
check "Footer source"          "Source: Robert(GPT) KB + Git"                                                  "components/site-footer.tsx"
...
check "Metadata source"        "Source: Robert(GPT) KB + Git"                                                  "components/page-metadata.tsx"
