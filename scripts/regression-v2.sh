...
echo
echo "[2/7] Home page (External mode locked content)"
check "Hero H1"               "AI Orchestration Governance"                                                "app/page.tsx"
check "Hero subtitle"         "A portfolio case study on designing governance"                            "app/page.tsx"
check "Tagline"               "Tools change. Governance discipline doesn"                                 "app/page.tsx"
check "Exec card 1"           "What this is"                                                              "app/page.tsx"
check "Exec card 2"           "What this proves"                                                          "app/page.tsx"
check "Exec card 3"           "What this is not"                                                          "app/page.tsx"
check "Exec card 4"           "Why it matters"                                                            "app/page.tsx"
...
check "Toggle external btn"    "External"                                                                 "components/view-toggle.tsx"
check "Toggle internal btn"    "Internal"                                                                 "components/view-toggle.tsx"
check "Toggle focus-ring"      "focus-visible:ring-2"                                                     "components/view-toggle.tsx"
