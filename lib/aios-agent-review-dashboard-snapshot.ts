...
export const snapshotCards: SnapshotCard[] = [
  ...
  },
  {
    ...
    sourceType: "commit",
    confidence: "high",
    remark: "Dashboard/data ambiguity routes through Data Team before Sararin.",
    lastUpdated: "2026-06-04",
    decisionUse: "Prevents raw dashboard questions from going to Sararin.",
    missingFields: "none",
